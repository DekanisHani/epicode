...
function concString (stringa1,stringa2) {
  return stringa1.substr(0,2).concat(stringa2.substr(-3,3));
}
console.log(concString("buongiorno", " a tutti"));
 ...
 */
var pari = (n) => {
  return n.filter(element => element % 2 === 0);
}
console.log(pari([3, 6, 9, 12, 15, 18]));
